...
/**
 * Reads edges data from Accumulo.
 */
public class EdgeInputFormat extends AbstractAccumuloInputFormat<Edge> {
   ...
   */
  public EdgeInputFormat(GradoopAccumuloConfig config) {
    super(config);
  }
  ...
  @Override
  public Edge nextRecord(Edge epgmEdge) {
    return null;
  }
}
