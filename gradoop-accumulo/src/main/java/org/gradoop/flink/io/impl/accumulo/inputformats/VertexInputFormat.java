...
/**
 * Reads vertex data from Accumulo.
 */
public class VertexInputFormat extends AbstractAccumuloInputFormat<Vertex> {
   ...
   */
  public VertexInputFormat(GradoopAccumuloConfig config) {
    super(config);
  }
  ...
  @Override
  public Vertex nextRecord(Vertex epgmVertex) {
    return null;
  }
}
